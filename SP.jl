...
using KNITRO
function SP(testsystemT, testsystemD, busT_gep, busD_gep, κ, setT, η, σ0_pv, σ0_wind, υ0, πDER, πC, s, τe, τc, Solver, D_ratio, ScaleObj, SD_tol, M, N, ED, γCT, ST_res, WMP, CTI)   
